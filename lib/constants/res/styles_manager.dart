...
// regular style
 TextStyle getRegularStyle(
     {double fontSize = FontSize.s12, required Color color,
       String fontFamily=FontConstant.fontFamilyDM}) {
 ...
 TextStyle getLightStyle(
     {double fontSize = FontSize.s12,
       String fontFamily=FontConstant.fontFamilyDM, required Color color}) {
   return _getTextStyle(
 ...
 TextStyle getSemiBoldStyle(
     {double fontSize = FontSize.s12,String fontFamily=FontConstant.fontFamilyDM,
